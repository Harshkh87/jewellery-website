...
import Img1 from '../../../asset/Image/Group 1487.svg'
import {
    ChakraProvider,
    Container,
    Heading,
  ...
  return (
    <ChakraProvider theme={Fonts}>
            {/* <div className='body-oneonly'> */}
                <Container maxW="5xl" px={{ base: 6, md: 3 }}  >
                    <Stack direction={{ base: 'column', md: 'row' }} alignItems='center' gap='10'justifyContent="center">
                        ...
                        <Stack direction="column" spacing={10} pr='10px'>
                            <Box align='center'>
                                ...
                                >
                                    Pikup Silver Sterling Designer Ring
                                </Heading>
                                <Text
                                    color='#6A6A6A'
                                    fontSize="1.2rem"
                                ...
                                <button className="button-sy2 button-sy3">SHOP NOW</button>
                                    ...
                                    {/* <button className="button-sy2 ">SHOP NOW</button> */}
